...
class partial_Clipboard_Tab_672de10a79b0df4ecf70c41724e62b969da287de extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure47 = $arguments46['value'] ? function() use ($arguments46) { return $arguments46['value']; } : $renderChildrenClosure47;
...
$renderChildrenClosure64 = $arguments63['value'] ? function() use ($arguments63) { return $arguments63['value']; } : $renderChildrenClosure64;
...
$expression41 = function($context) {return (($context["node0"]) == ($context["node2"]));};
...
$renderChildrenClosure25 = $arguments24['value'] ? function() use ($arguments24) { return $arguments24['value']; } : $renderChildrenClosure25;
...
$expression82 = function($context) {return (($context["node0"]) == ($context["node2"]));};
